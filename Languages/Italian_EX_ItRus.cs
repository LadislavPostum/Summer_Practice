...
namespace Languages
{
    public partial class Italian_EX_ItRus : Form
    {
        public Italian_EX_ItRus()
        {
            InitializeComponent();
        ...
        public Italian_EX_ItRus(Italian_Exercises IE, int a, int b)
        {
            InitializeComponent();
            ...
            if (i != 0)
            {
                label4.Text = this.italian_DataBaseDataSet.Table.Rows[j][1].ToString();
                label5.Text = this.italian_DataBaseDataSet.Table.Rows[j][2].ToString();
            }
        }
        ...
        private void Italian_EX_ItRus_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (CloseFlag != 0)
            {
                Application.Exit();
