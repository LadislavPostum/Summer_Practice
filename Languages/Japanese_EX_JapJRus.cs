...
namespace Languages
{
    public partial class Japanese_EX_JapJRus : Form
    {
        ...
        public Japanese_EX_JapJRus(Japanese_Exercises JE, int a, int b)
        {
            ...
            toolTip2.SetToolTip(button2, "Проверить кану");
            ...
            if (i != 0)
            {
                label4.Text = this.japanese_DataBaseDataSet.Table.Rows[j][1].ToString();
                label5.Text = this.japanese_DataBaseDataSet.Table.Rows[j][2].ToString();
